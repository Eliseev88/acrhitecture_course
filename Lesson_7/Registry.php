...
/*
    ПАТТЕРН РЕЕСТР БЫЛ ПРИМЕНЕН В ДАННОМ СЛУЧАЕ ДЛЯ ХРАНЕНИЯ ОБЪЕКТОВ В КОНТЕЙНЕРЕ И ИХ ПОСЛЕДУЮЩЕГО ПОЛУЧЕНИЯ.
    В ДАННОМ СЛУЧАЕ КОНКРЕТНО ДЛЯ КОНФИГА И РЕНДЕРА СТРАНИЦЫ ПО НАЗВАНИЮ МАРШРУТА
